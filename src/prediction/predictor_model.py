...
class TimeStepClassifier:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Decision Tree TimeStepClassifier.
    ...
    def build_model(self) -> DecisionTreeClassifier:
        """Build a new Decision Tree Classifier."""
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Decision Tree TimeStepClassifier to disk.
    ...
    def load(cls, model_dir_path: str) -> "TimeStepClassifier":
        """Load the Decision Tree TimeStepClassifier from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TimeStepClassifier: A new instance of the loaded Decision Tree TimeStepClassifier.
        """
