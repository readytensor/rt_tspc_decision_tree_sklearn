...
class TSAnnotator:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Decision Tree TSAnnotator.
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Decision Tree TSAnnotator to disk.
    ...
    def load(cls, model_dir_path: str) -> "TSAnnotator":
        """Load the Decision Tree TSAnnotator from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TSAnnotator: A new instance of the loaded Decision Tree TSAnnotator.
        """
