# Decision Tree Time Step Classifier in Scikit-learn

Decision Tree Time Step Classifcation Model in Scikit-learn as per Ready Tensor specifications.
...
- A **Decision Tree Time Step Classifcation n** model built using **Scikit-learn**
